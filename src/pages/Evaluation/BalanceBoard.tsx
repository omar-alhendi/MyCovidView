            ...
            feature: {
                ...
                dataView: {
                    ...
                    optionToContent: function (opt: any) {
                        ...
                        let table = '<table id="dataTable1" border="1" style="margin-left:20px;border-collapse:collapse;font-size:14px;text-align:center;background-color:#fff;width:60%"><tbody><tr>' + tdHeads + '</tr>';
                        let tdBodys = '';
                    ...
                    contentToOption: function () {
                        ...
                        const ws1 = XLSX.utils.table_to_sheet(document.getElementById("dataTable1"));
